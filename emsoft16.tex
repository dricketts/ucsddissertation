...
\node[anchor=west,fill=white,opacity=0.75,inner sep=0em,text width=1.25cm,align=center] at (-1.75,0.5) {\small Restricted Zone} ;
\node[anchor=west,inner sep=0em,text width=1.25cm,align=center] at (-1.75,0.5) {\small Restricted Zone} ;
...
As in Chapter~\ref{chap:memo15}, the conjunction of two systems is defined
as follows:
...
Note that our 1D position controller ($b$ in Figure~\ref{fig:monitors})
