...
In~\cite{mitchell2015improved,mitchell2013safety}, Mitchell \emph{et al.}
present algorithms for computing the discriminating kernel of a
sampled-data systems for an invariant set. The discriminating kernel
characterizes the set of initial states of the system for which there
exists a control law that keeps all trajectories inside the invariant set.
The algorithm in~\cite{mitchell2015improved} only computes the
