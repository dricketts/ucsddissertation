...
\chapter{Discrete Induction and Sequential Composition for Sampled-Data Systems}
\label{chap:memo15}
\input{memo15}

\chapter{Modular Verification of Sampled-Data Systems}
\label{chap:emsoft16}
\input{emsoft16}

\chapter{Barrier Certificates for Sampled-Data Systems}
\label{chap:exp-smpl}
\input{exp-smpl}
